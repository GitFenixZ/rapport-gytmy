...
\begin{figure}[h!]
    \centering
    \subfloat[\centering Joueur pas prêt]{\includegraphics[scale=0.4]{ressources/Implementation/Labyrinthe/Controleur/SettingsMenu_NotReady.png}}%
    \qquad
    \subfloat[\centering Liste des joueurs disponibles]{\includegraphics[scale=0.4]{ressources/Implementation/Labyrinthe/Controleur/SettingsMenu_PlayerList.png}}%
    \qquad
    \subfloat[\centering Joueur prêt]{\includegraphics[scale=0.4]{ressources/Implementation/Labyrinthe/Controleur/SettingsMenu_Ready.png}}%
