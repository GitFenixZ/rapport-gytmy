...
\begin{figure}[h!]
    \centering
    \subfloat[\centering Joueur pas prêt]{\includegraphics[width=6.5cm]{ressources/Implementation/Labyrinthe/Controleur/SettingsMenu_NotReady.png}}%
    \qquad
    \subfloat[\centering Liste des joueurs disponibles]{\includegraphics[width=6.5cm]{ressources/Implementation/Labyrinthe/Controleur/SettingsMenu_PlayerList.png}}%
    \qquad
    \subfloat[\centering Joueur prêt]{\includegraphics[width=6.5cm]{ressources/Implementation/Labyrinthe/Controleur/SettingsMenu_Ready.png}}%
