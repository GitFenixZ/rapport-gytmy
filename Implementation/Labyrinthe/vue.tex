...
\begin{figure}[!htb]%
    \centering
    \subfloat[\centering Décompte]{{\includegraphics[scale=0.5]{ressources/Implementation/Labyrinthe/Vue/CountdownTimer/CountDown.png}}}%
    \qquad
    \subfloat[\centering Timer]{{\includegraphics[scale=0.5]{ressources/Implementation/Labyrinthe/Vue/CountdownTimer/Timer.png}}}%
