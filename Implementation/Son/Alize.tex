...
Afin de gérer toute la partie audio, nous avons crée une classe \textbf{\textit{ModelManager}} qui s'occupe de la modélisation et de la reconnaissance. Elle
...
est , non seulement l'execution des programmes, mais aussi la gestion des fichiers et des listes de fichiers à utiliser pour la modélisation et la
reconnaissance, ces fonctions sont partagées avec la classe \textbf{\textit{AudioManager}} qui s'occupe de la partie audio.

Comment obtenir un résultat? Une fois que Alizé a fait son travail il faut interpreter le résultat. Ce procédé est réalisé par les classes
